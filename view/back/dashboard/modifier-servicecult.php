...
if(isset($_POST['submit']))
 ...
 $eid=$_GET['editid'];
    ...
    $query=mysqli_query($con, "UPDATE produitscult SET titreProd='$titre',descProd='$desc',prixProd='$prix',quantProd='$quant',img1='$img1',img2='$img2',img3='$img3' WHERE idProd=$eid");
    if ($query) {
...
<body class="cbp-spmenu-push">
  ...
  <?php
 $cid=$_GET['editid'];
$ret=mysqli_query($con,"select * from  produitscult where idProd='$cid'");
$cnt=1;
