...
if (strlen($_SESSION['idlogin']==0)) {
    ...
    $commandes=$commandeC->affichercommande($_SESSION['idlogin']);
    $adresses=$livraisonC->retourAdresse($_SESSION['idlogin']);
    $achats=$achatC->afficherAchats($_SESSION['idlogin']);

    foreach($commandes as $row){ 
        echo $row['idCmd'];
        echo $row['prixtot'];
        foreach($adresses as $row1){
            echo $row1['lieu'];
    }}
?>
...
<head>
    <title>MiniArt | Mes Achats</title>
    <meta charset="utf-8">
...
<body>
    ...
    <div class="container contact_container">
        ...
        <table class="table table-bordered">
            <thead>
                <tr>
                    <th scope="col" width="20%" style="text-align: center;">Numéro de commande</th>
                    <th scope="col" style="text-align: center;">Prix Total</th>
                    <th scope="col" style="text-align: center;">Adresse Livraison</th>
                    <th scope="col" style="text-align: center;">Facture</th>
            ...
            <tbody>
                ...
                <tr style="text-align: center;">
                    <th scope="row" ><?php echo $row['idCmd']; ?></th>
                    <td><?php echo $row['prixtot']; ?></td>
                    <td><?php echo $row['lieu']; ?></td>
                    <td><button type="button" class="btn btn-danger"><a href="facture.php?idAchat=<?php echo $row['idAchat']; ?>" style="border-style: none; color:white;">Afficher</a></button></td>
                </tr>
                <?php } ?>
            </tbody>
        </table>
