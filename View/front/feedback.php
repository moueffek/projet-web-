	...
	<div class="container contact_container">
		...
		<div class="row">
			<div class="col">
				...
				<textarea id="input_message" class="input_ph input_message" name="message"  placeholder="Votre Avis" rows="3" required data-error="Message vide."></textarea>
				<div class="etoiles">
