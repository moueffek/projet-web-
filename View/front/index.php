...
error_reporting(0);
    ...
    try{
		...
		/*if($count > 0){
			$_SESSION['idlogin']=$ret['id'];
			header('location:../back/test.php');
		}*/
		$_SESSION['idlogin']=$ret['id'];
		...
		<div class="row">
			...
			<div class="col-lg-6 get_in_touch_col">
				<div class="get_in_touch_contents">
					...
					<label for=""></label>
					<form method="post" action="../back/ajouterUtilisateur.php">
						<div>
						<input id="input" class="form_input input_ph" type="text" name="nomUt" placeholder="Nom Utilisateur" required="required" data-error="Obligatoire.">
							<input id="input" class="form_input input_ph" type="password" name="pass" placeholder="Mot de Passe" required="required" data-error="Obligatoire.">
							<input id="input" class="form_input input_ph" type="text" name="email" placeholder="Email" required="required" data-error="Obligatoire.">
							<input id="input" class="form_input input_ph" type="text" name="nomPrenom" placeholder="Nom et Prenom" required="required" data-error="Obligatoire.">
							<input id="input" class="form_input input_ph" type="text" name="pays" placeholder="Pays" required="required" data-error="Obligatoire.">
							<input id="input" class="form_input input_ph" type="text" name="adresse" placeholder="Adresse" required="required" data-error="Obligatoire.">
							<input id="input" class="form_input input_ph" type="text" name="tel" placeholder="Telephone" required="required" data-error="Obligatoire.">
			...
			<div class="col-lg-6 get_in_touch_col">
				<div class="get_in_touch_contents">
					...
					<form method="post">
						<div>
						<input id="input" class="form_input input_ph" type="text" name="nomUtlog" placeholder="Nom Utilisateur" required="required" data-error="Obligatoire.">
							<input id="input" class="form_input input_ph" type="password" name="passlog" placeholder="Mot de Passe" required="required" data-error="Obligatoire.">
						</div>
						<div>
